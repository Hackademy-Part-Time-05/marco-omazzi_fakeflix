        ...
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                    <a href="{{route('cataloguefilms')}}"> <button type="button" class="btn btn-danger btn-lg px-4 me-sm-3" >Guarda i Film</button> </a>
                    <a href="{{route('catalogueseries')}}"> <button type="button" class="btn btn-danger btn-lg px-4 me-sm-3">Serie Tv</button> </a>
                </div>
            </div>
